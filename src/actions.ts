...
// export async function fetch_nodes_of_workspace(workspace_uuid: string) {
//     const allNodes = await db.select().from(nodesTable).where(eq(nodesTable.workspace_id, workspace_uuid));
//     return allNodes;
// }

export async function fetch_workspace_data(
